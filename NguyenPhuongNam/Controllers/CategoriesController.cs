...
using NguyenPhuongNam.Models;
using PagedList;

namespace NguyenPhuongNam.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Delete(int? id, bool? saveChangesError = false)
        {
            ...
            {
                ViewBag.ErrorMessage = "Delete failed. Please try again and if the problem persists, see the product.";
            }
            Category category = db.Categories.Find(id);
            if (category == null)
            {
        ...
        {
            Category category = db.Categories.Find(id);
            var pro = db.Products.FirstOrDefault(n => n.CategoryID == id);
            if (pro != null)
            {
